...
let s:c.base1 = { 'gui': '#11151c', 'cterm': 0 }
let s:c.base2 = { 'gui': '#091f2e', 'cterm': 8 }
let s:c.base3 = { 'gui': '#0a3749', 'cterm': 12 }
let s:c.base4 = { 'gui': '#245361', 'cterm': 14 }
...
let s:IA1 = s:Array('base4', 'base0')
let s:IA2 = s:Array('base4', 'base0')
